export const CLASSES = {
	layout: {
		...
		sectionDark:
			"py-20 bg-brand-500 text-white transition-colors duration-300",
		container: "container mx-auto px-4",
		containerNarrow: "max-w-4xl mx-auto",
		containerArticle: "max-w-3xl mx-auto",
		pagePadding: "py-20",
		headerContainer: "container mx-auto px-4 py-4 flex justify-between items-center",
		...
		aboutHeader: "bg-neutral-50 dark:bg-neutral-800 py-20 border-b border-neutral-100 dark:border-neutral-900",
	},
	typography: {
		h1: "text-4xl lg:text-6xl font-extrabold text-neutral-900 dark:text-white leading-tight",
		h1Page: "text-4xl lg:text-5xl font-extrabold text-neutral-900 dark:text-white leading-tight",
		h1Medium: "text-4xl font-extrabold text-neutral-900 dark:text-white leading-tight",
		...
		footerText: "text-neutral-700 dark:text-neutral-500 text-sm leading-relaxed",
		listItem: "flex items-start gap-2 text-neutral-600 dark:text-neutral-400",
		listItemLabel: "text-neutral-700 dark:text-neutral-300 leading-tight font-medium",
		copyright:
	...
	visual: {
		...
		avatarAccent: "absolute -bottom-2 -right-2 bg-brand-500 w-8 h-8 rounded-full border-4 border-white dark:border-neutral-900",
		checkIcon:
